#ifndef _DATABASE_2011_
#define _DATABASE_2011_
 ...
 * @param column_name Name list of the columns.
 * @param column_type Type list of the columns.
 * @param primary_key Column list of the primary key.
 * @note The primary keys will be unique.
 * @note The primary keys will be given in ascending order.
 * @note The orders of elements of column_name, column_type,
 *       and primary_key are very important.
